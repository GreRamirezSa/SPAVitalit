 ...
 * @author lis_h
 */
public class PedidosAsistente extends javax.swing.JFrame {

    ProductAsistente pPedidos;
    int contador = 0;
    private int l;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedidosAsistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PedidosAsistente().setVisible(true);
            }
        });
    }
