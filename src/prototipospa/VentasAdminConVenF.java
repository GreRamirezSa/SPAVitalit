 ...
 * @author lis_h
 */
public class VentasAdminConVenF extends javax.swing.JFrame {

    VentasAdminPedidos pAdmin;
    OpcionesVenta oV;
    ConVenBuscar go;
    int contador = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentasAdminConVenF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new VentasAdminConVenF().setVisible(true);
        });
    }
