 ...
 * @author lis_h
 */
public class ConVenBuscarAsistente extends javax.swing.JFrame {

    principalAdmin pAdmin;
    VentasAsistenteConVen re;
    OpcionesVenta oV;
    int contador = 0;
...
///inicia tercera tabla/////////////////////////
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConVenBuscarAsistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ConVenBuscarAsistente().setVisible(true);
        });
    }
