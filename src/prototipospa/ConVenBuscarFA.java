 ...
 * @author lis_h
 */
public class ConVenBuscarFA extends javax.swing.JFrame {

    principalAdmin pAdmin;
     VentasAsistenteConVenF re;
    OpcionesVenta oV;
    int contador = 0;
...
///inicia tercera tabla/////////////////////////
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConVenBuscarFA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ConVenBuscarFA().setVisible(true);
        });
    }
