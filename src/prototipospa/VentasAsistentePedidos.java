 ...
 * @author lis_h
 */
public class VentasAsistentePedidos extends javax.swing.JFrame {

    principalAdmin pAdmin;
    OpcionesVentaAsistente oV;
    VentasAsistenteConVen ir;
    int contador = 0;
    int c1 = 0, c2 = 0, c3 = 0;
    private int l, n, m;
    ...
    public VentasAsistentePedidos() {
        try {
          ...
          //  Certificado("1000");
            ...
            Logger.getLogger(VentasAsistentePedidos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
 ...
 Connection miCon, miCon2, miCon4;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentasAsistentePedidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new VentasAsistentePedidos().setVisible(true);
        });
    }
