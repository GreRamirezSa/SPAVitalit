 ...
 * @author lis_h
 */
public class ServiciosAsistente extends javax.swing.JFrame {
    PrincipalAsistente pAdmin;

    /**
     * Creates new form ServiciosAdmin
     */
    public ServiciosAsistente() {
        initComponents();
        actualizar();
 ...
 ex.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServiciosAsistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServiciosAsistente().setVisible(true);
            }
        });
    }
