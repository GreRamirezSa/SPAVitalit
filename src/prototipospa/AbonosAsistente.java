 ...
 * @author lis_h
 */
public class AbonosAsistente extends javax.swing.JFrame {

    OpcionesVentaAsistente pOV;

    /**
     * Creates new form usuariosAdmin
     */
    public AbonosAsistente() {
        initComponents();
        actualizarC();
    ...
    private void button_regresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_regresarMouseClicked
        pOV = new OpcionesVentaAsistente();
        pOV.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbonosAsistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbonosAsistente().setVisible(true);
            }
        });
    }
