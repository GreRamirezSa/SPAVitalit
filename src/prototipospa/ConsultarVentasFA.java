 ...
 * @author Daniel
 */
public class ConsultarVentasFA extends javax.swing.JFrame {
    principalAdmin back;

    /**
     * Creates new form ConsultarVentas
     */
    public ConsultarVentasFA() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarVentasF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarVentasF().setVisible(true);
            }
        });
    }
