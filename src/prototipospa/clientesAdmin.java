...
public class clientesAdmin extends javax.swing.JFrame {
    ...
    private void button_eliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_eliminarMouseClicked
        ...
        int response = JOptionPane.showConfirmDialog(this, "¿Esta seguro que eliminar a " + nu + "?", "ATENCIÓN",
                JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (response == JOptionPane.NO_OPTION) {
            ...
            if (!nu.equals("")) {
                if (miCon != null) {
                    try {
                        String sql = "DELETE FROM clientes WHERE no_tel=" + "'" + nu + "'";
                        Statement stmt = miCon.createStatement();
                    ...
                    while(r.next()){    
                        ...
                        JOptionPane.showMessageDialog(this, "No se pudo eliminar, el registro esta en uso en la base de datos", "Error",
                                JOptionPane.ERROR_MESSAGE);
                    }
                }
            } else {
                JOptionPane.showMessageDialog(this, "Error, ingresar número a eliminar");
            }
            actualizar();
            txt_no.setText("");
        } else if (response == JOptionPane.CLOSED_OPTION) {
    ...
    private void button_actualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_actualizarMouseClicked
        ...
        if (!n.equals("")) {
            if (miCon != null) {
                ...
                if (!Existe(no)) {
                    try {
                        String sql2 = "select no_tel from clientes where no_tel='" + num + "'";
                        Statement stmt2 = miCon.createStatement();
                        ResultSet r = stmt2.executeQuery(sql2);
                        r.next();
                        if (r.getString("no_tel") != null) {

                            //stmt2.close();
                            System.out.println("LLego");
                            String sql = "UPDATE clientes SET no_tel= '" + no + "' WHERE no_tel='" + num + "'";
                            Statement stmt = miCon.createStatement();
                            stmt.executeUpdate(sql);
                            stmt.close();
                            JOptionPane.showMessageDialog(this, "Actualizado con éxito");
                        } else {
                            //JOptionPane.showMessageDialog(this, "Número no existe");
                        }
                    ...
                    //JOptionPane.showMessageDialog(this, "Error existe ese numero");
                }
            }
            txt_mail.setText("");
            txt_no.setText("");
            ...
            JOptionPane.showMessageDialog(this, "Error, actualizar por número de teléfono");
        }
        actualizar();
    ...
    public String nuevoNum() {
        ...
        do {
            try {
                ...
                JOptionPane.showMessageDialog(this, "solo numeros alv");
                continu = false;
            }
        } while (continu);
        return "";
    ...
    public Boolean Existe(String numero) {
        ...
        if (miCon != null) {
            try {
                String sql = "SELECT no_tel FROM clientes WHERE no_tel= '" + numero + "'";
                Statement stmt = miCon.createStatement();
                ResultSet r = stmt.executeQuery(sql);
                if (r.next()) {
                    String cad = r.getString("no_tel") + "";
                    if (cad.equals(numero)) {
                        return true;
                    }
                }
            } catch (SQLException e) {
