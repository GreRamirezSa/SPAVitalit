...
public class InventarioAdmin extends javax.swing.JFrame {
    ...
    private void button_eliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_eliminarMouseClicked
        ...
        int response = JOptionPane.showConfirmDialog(this, "¿Esta seguro que desea eliminar?", "ATENCIÓN",
                JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        switch (response) {
            case JOptionPane.NO_OPTION:
                break;
    ...
    private void button_actualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_actualizarMouseClicked
        ...
        String st = txt_exis.getText();
        String pr = txt_pre.getText();

        int response = JOptionPane.showConfirmDialog(this, "Confirme la operación, ¿Desea actualizar?", "ATENCIÓN",
                JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        switch (response) {
            case JOptionPane.NO_OPTION:
                break;
            case JOptionPane.YES_OPTION:
                ...
                miCon = (new ConexionBD()).conectar();
                if (!id.equals("")) {
                    if (!st.equals("") || !pr.equals("")) {
                        if (miCon != null) {
                            try {

                                String sql = verificar(st, pr) + id;
                                Statement stmt = miCon.createStatement();
                                stmt.executeUpdate(sql);
                                actualizar();
                                stmt.close();
                        ...
                        JOptionPane.showMessageDialog(this, "Ingrese el precio o existencia a actualizar");
                    }

                } else {
                    JOptionPane.showMessageDialog(this, "Ingrese el id a actualizar");
                }
                break;
            case JOptionPane.CLOSED_OPTION:
                break;
